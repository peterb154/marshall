...
| ID | Prio | Test | What should happen | Fix under test |
|---
| **H20** | Get established on the final approach course, then say nothing for two calls | You are **never told to hold** once radar shows you established. A holding clearance there is stale by definition — you cannot both be on final and be waiting to start. This is the bug the whole reconcile layer exists for: a pilot at ten miles was once told, in one transmission, that he was on final AND to climb to five thousand and hold | [#80] | **P1** |
| **H21** | The same, but listen for a **second** altitude anywhere in the transmission | One altitude per transmission. If you hear the talk-down and a holding level together, that is the regression | [#80] | **P1** |-|---
| **H20** | Get established on the final approach course, then say nothing for two calls | You are **never told to hold** once radar shows you established. A holding clearance there is stale by definition — you cannot both be on final and be waiting to start. This is the bug the whole reconcile layer exists for: a pilot at ten miles was once told, in one transmission, that he was on final AND to climb to five thousand and hold | [#80] | **P1** |
| **H21** | The same, but listen for a **second** altitude anywhere in the transmission | One altitude per transmission. If you hear the talk-down and a holding level together, that is the regression | [#80] | **P1** |---
| **H20** | Get established on the final approach course, then say nothing for two calls | You are **never told to hold** once radar shows you established. A holding clearance there is stale by definition — you cannot both be on final and be waiting to start. This is the bug the whole reconcile layer exists for: a pilot at ten miles was once told, in one transmission, that he was on final AND to climb to five thousand and hold | [#80] | **P1** |
| **H21** | The same, but listen for a **second** altitude anywhere in the transmission | One altitude per transmission. If you hear the talk-down and a holding level together, that is the regression | [#80] | **P1** ||---
...
| **S9** | **Every clearance you are given** — taxi, take-off, approach, landing, a hold | The **numbers actually reach you.** The engine decides them and the agent phrases them; if it phrases them away, the bridge now appends the missing clause. On the recorded sortie *"runway one three, cleared for take-off"* was transmitted as **"Sockeye, roger."** and a refusal naming Tower 133.0 came out as **"go ahead."** Report any clearance that arrives without its runway, level, station or frequency | [#79] | **P1** |
| **S10** | A repaired transmission (S9 firing) | It should sound like **one controller finishing his sentence**, not like a machine reading a template after a human. The agent's words are kept and the missing clause is added — if it sounds bolted on, or says the same thing twice, that is the finding | [#79] | P2 |
| **S11** | Any digit in any transmission | **Never a spoken number.** "runway one three", not "thirteen"; "two thousand", not "two zero zero zero". Every quantity is spelled on its way to the radio now | [#79] | **P1** |
