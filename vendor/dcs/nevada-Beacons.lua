...
beacons = {
	...
	{
		display_name = _('McCarran-International');
	...
	};
	{
		...
		sceneObjects = {'t:75498833'};
	};
	{
		display_name = _('Tonopah-Test-Range');
	...
	};
	{
		...
		channel = 77;
		position = { -227436.906250, 1689.105083, -174559.000000 };
		direction = -24.171672;
	...
	};
	{
		...
		channel = 119;
		position = { -200809.968750, 1631.569136, -196936.796875 };
		direction = -141.002194;
	...
	};
	{
		...
		channel = 114;
		position = { -424440.156250, 1080.228009, -1424.503052 };
		direction = 41.253552;
		positionGeo = { latitude = 35.995752, longitude = -114.863607 };
		sceneObjects = {'t:65438387'};
	};
	{
