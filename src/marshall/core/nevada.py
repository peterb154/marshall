...
NELLIS_FIELD = Field_(
    ...
    "Nellis", -398195, -17233, 1869, 209, ends=(21, 3),
    atis_mhz=118.400, atis_uhf_mhz=281.000,
...
TONOPAH_FIELD = Field_(
    "Tonopah", -226613, -174653, 5550, 141, ends=(15, 33),
    atis_mhz=118.600, atis_uhf_mhz=282.000,
